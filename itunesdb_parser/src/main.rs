    ...
    if itunesdb_file_type == "photo" {
        ...
        while idx < db_file_as_bytes.len() { // TODO: Inside of each of the ifs, advance the index correctly
            ...
            (db_file_as_bytes[idx + 3] == image_list_key_ascii[3]) {
                ...
                let image_list_num_images : u32 = helpers::helpers::build_le_u32_from_bytes(image_list_num_images_raw);
            ...
            (db_file_as_bytes[idx + 3] == image_item_key_ascii[3]) {
                ...
                let image_item_rating : u32 = helpers::helpers::build_le_u32_from_bytes(image_item_rating_raw);
                ...
                let image_item_source_img_size = helpers::helpers::build_le_u32_from_bytes(image_item_source_img_size_raw);
            ...
            (db_file_as_bytes[idx + 3] == image_name_key_ascii[3]) {
                ...
                let image_name_img_size = helpers::helpers::build_le_u32_from_bytes(image_name_img_size_raw);
                ...
                let image_name_img_height = helpers::helpers::build_le_u32_from_bytes(image_name_img_height_raw);
                ...
                let image_name_img_width = helpers::helpers::build_le_u32_from_bytes(image_name_img_width_raw);
            ...
            (db_file_as_bytes[idx + 3] == photo_album_key_ascii[3]) {
                ...
                let photo_album_item_cnt = helpers::helpers::build_le_u32_from_bytes(photo_album_item_cnt_raw);
            ...
            (db_file_as_bytes[idx + 3] == data_object_key_ascii[3]) {
                ...
                let data_object_type = helpers::helpers::build_le_u32_from_bytes(data_object_type_raw);

                if data_object_type == 1 || data_object_type == 3 {

                    let data_object_subcontainer_str_len = helpers::helpers::build_le_u32_from_bytes(&db_file_as_bytes[idx + data_object_string_subcontainer_length_offset .. idx + data_object_string_subcontainer_length_offset + data_object_string_subcontainer_length_len]);

                    let data_object_subcontainer_encoding = helpers::helpers::build_le_u32_from_bytes(&db_file_as_bytes[idx + data_object_string_subcontainer_encoding_offset .. idx + data_object_string_subcontainer_encoding_offset + data_object_string_subcontainer_encoding_len]);
