use crate::constants::{itunesdb_constants, itunessd_3g_constants};
use crate::helpers::helpers;


pub fn parse_itunessd_3rdgen_file(itunessd_file_as_bytes: Vec<u8>)
{
    ...
    while idx < itunessd_file_as_bytes.len()
    {
        ...
        if itunessd_3rd_gen_heading == itunessd_3g_constants::ITUNESSD_3RDGEN_SHUFFLE_DB_HEADER_ID_KEY.as_bytes() {

            let shuffle_db_header_length = helpers::build_le_u32_from_bytes(&helpers::get_slice_from_offset_with_len(
                idx,
            ...
            if (shuffle_db_header_length != itunessd_3g_constants::ITUNESSD_3RDGEN_SHUFFLE_DB_HEADER_EXPECTED_LENGTH as u32) {
                panic!(
            ...
            let num_tracks_total = helpers::build_le_u32_from_bytes(&helpers::get_slice_from_offset_with_len(
                idx,
                &itunessd_file_as_bytes,
            ...
            let num_tracks_music_only = helpers::build_le_u32_from_bytes(&helpers::get_slice_from_offset_with_len(
                idx,
                &itunessd_file_as_bytes,
            ...
            let num_playlists = helpers::build_le_u32_from_bytes(&helpers::get_slice_from_offset_with_len(
                idx,
                &itunessd_file_as_bytes,
            ...
            println!("iTunesSD file has {} tracks overall ({} music-only), {} playlists",
                num_tracks_total,
                num_tracks_music_only,
                num_playlists
            );
        ...
        else if itunessd_3rd_gen_heading == itunessd_3g_constants::ITUNESSD_3RDGEN_TRACKS_HEADER_ID_KEY.as_bytes() {
            
            let num_tracks_in_group = helpers::build_le_u32_from_bytes(&helpers::get_slice_from_offset_with_len(
                idx,
                &itunessd_file_as_bytes,
        ...
        else if itunessd_3rd_gen_heading == itunessd_3g_constants::ITUNESSD_3RDGEN_TRACK_ENTRY_HEADER_ID_KEY.as_bytes() {

            let track_entry_header_length = helpers::build_le_u32_from_bytes(&helpers::get_slice_from_offset_with_len(
                idx,
                &itunessd_file_as_bytes,
            ...
            if (track_entry_header_length != itunessd_3g_constants::ITUNESSD_3RDGEN_TRACK_ENTRY_HEADER_EXPECTED_SIZE as u32) {
                panic!(
            ...
            let start_time_ms = helpers::build_le_u32_from_bytes(&helpers::get_slice_from_offset_with_len(
                idx,
                &itunessd_file_as_bytes,
            ...
            let stop_time_ms = helpers::build_le_u32_from_bytes(&helpers::get_slice_from_offset_with_len(
                idx,
                &itunessd_file_as_bytes,
            ...
            let volume_gain = helpers::build_le_u32_from_bytes(&helpers::get_slice_from_offset_with_len(
                idx,
                &itunessd_file_as_bytes,
            ...
            let file_type = helpers::build_le_u32_from_bytes(&helpers::get_slice_from_offset_with_len(
                idx,
                &itunessd_file_as_bytes,
            ...
            let filename = String::from_utf8_lossy(filename_bytes).trim_end_matches('\0').to_string();

            let bookmark_ms = helpers::build_le_u32_from_bytes(&helpers
::get_slice_from_offset_with_len(
                idx,
                &itunessd_file_as_bytes,
            ...
            let pregap = helpers::build_le_u32_from_bytes(&helpers::get_slice_from_offset_with_len(
                idx,
                &itunessd_file_as_bytes,
            ...
            let postgap = helpers::build_le_u32_from_bytes(&helpers::get_slice_from_offset_with_len(
                idx,
                &itunessd_file_as_bytes,
            ...
            let num_samples = helpers::build_le_u32_from_bytes(&helpers::get_slice_from_offset_with_len(
                idx,
                &itunessd_file_as_bytes,
            ...
            let gapless_data = helpers::build_le_u32_from_bytes(&helpers::get_slice_from_offset_with_len(
                idx,
                &itunessd_file_as_bytes,
            ...
            let album_id = helpers::build_le_u32_from_bytes(&helpers::get_slice_from_offset_with_len(
                idx,
                &itunessd_file_as_bytes,
            ...
            let track_num = helpers::build_le_u32_from_bytes(&helpers::get_slice_from_offset_with_len(
                idx,
                &itunessd_file_as_bytes,
            ...
            let disc_num = helpers::build_le_u32_from_bytes(&helpers::get_slice_from_offset_with_len(
                idx,
                &itunessd_file_as_bytes,
            ...
            let artist_id = helpers::build_le_u32_from_bytes(&helpers::get_slice_from_offset_with_len(
                idx,
                &itunessd_file_as_bytes,
